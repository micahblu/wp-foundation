...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __('No Repeat', 'wp-foundation'),
		'repeat-x'  => __('Repeat Horizontally', 'wp-foundation'),
		'repeat-y'  => __('Repeat Vertically', 'wp-foundation'),
		'repeat'    => __('Repeat All', 'wp-foundation'),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __('Top Left', 'wp-foundation'),
		'top center'    => __('Top Center', 'wp-foundation'),
		'top right'     => __('Top Right', 'wp-foundation'),
		'center left'   => __('Middle Left', 'wp-foundation'),
		'center center' => __('Middle Center', 'wp-foundation'),
		'center right'  => __('Middle Right', 'wp-foundation'),
		'bottom left'   => __('Bottom Left', 'wp-foundation'),
		'bottom center' => __('Bottom Center', 'wp-foundation'),
		'bottom right'  => __('Bottom Right', 'wp-foundation')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __('Scroll Normally', 'wp-foundation'),
		'fixed'  => __('Fixed in Place', 'wp-foundation')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __('Normal', 'wp-foundation'),
		'italic'      => __('Italic', 'wp-foundation'),
		'bold'        => __('Bold', 'wp-foundation'),
		'bold italic' => __('Bold Italic', 'wp-foundation')
		);
